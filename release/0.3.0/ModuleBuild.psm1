...
function Get-MBTBuildEnvironment {
    <#
        .EXTERNALHELP ModuleBuild-help.xml
        .LINK
            https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.0/docs/Get-BuildEnvironment.md
        #>
...
function Set-MBTBuildEnvironment {
    <#
        .EXTERNALHELP ModuleBuild-help.xml
        .LINK
            https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.0/docs/Set-BuildEnvironment.md
        #>
