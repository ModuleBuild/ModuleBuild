...
function Get-BuildEnvironment {
    ...
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.0.1/docs/Functions/Get-BuildEnvironment.md
    #>
...
function Initialize-ModuleBuild {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.0.1/docs/Functions/Initialize-ModuleBuild.md
    #>
...
function Set-BuildEnvironment {
    ...
    .EXTERNALHELP ModuleBuild-help.xml
    .LINK
        https://github.com/zloeber/ModuleBuild/tree/master/release/0.0.1/docs/Functions/Set-BuildEnvironment.md
    #>
