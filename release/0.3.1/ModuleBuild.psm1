...
function Add-MBPublicFunction {
    <#
        ...
        .LINK
            https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.1/docs/Add-MBPublicFunction.md
        #>
...
function Get-MBBuildEnvironment {
    <#
        .EXTERNALHELP ModuleBuild-help.xml
        .LINK
            https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.1/docs/Get-MBBuildEnvironment.md
        #>
    [CmdletBinding()]
    param(
        [parameter(Position = 0, ValueFromPipeline = $TRUE)]
...
function Import-MBModulePrivateFunction {
    <#
        .EXTERNALHELP ModuleBuild-help.xml
        .LINK
            https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.1/docs/Import-MBModulePrivateFunction.md
        #>
...
function Import-MBModulePublicFunction {
    <#
        .EXTERNALHELP ModuleBuild-help.xml
        .LINK
            https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.1/docs/Import-MBModulePublicFunction.md
        #>
...
function Initialize-MBModuleBuild {
    <#
        .EXTERNALHELP ModuleBuild-help.xml
        .LINK
            https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.1/docs/Initialize-MBModuleBuild.md
        #>
...
'@
            ...
            if (-not [string]::IsNullOrEmpty($SourceModule)) {
                if (-not [string]::IsNullOrEmpty($SourceModule))
                {
                    if (-not (test-path $SourceModule) -or ((Get-Item $SourceModule).Extension -notmatch '.psd1')) {
                        Write-Error "$($SourceModule) was not found or is not a psd1 module manifest file!"
            ...
            Try {
                Write-Verbose "Starting invoke-plaster"
                $PlasterResults = invoke-plaster @PlasterParams -NoLogo -PassThru -ErrorAction continue
            } Catch {
                Write-Error $PSItem
            }


            write-verbose "Get the newly created buildenvironment file and run it the first time to create the first export file."
...
Function Set-MBBuildEnvironment {
    <#
        .EXTERNALHELP ModuleBuild-help.xml
        .LINK
            https://github.com/zloeber/ModuleBuild/tree/master/release/0.3.1/docs/Set-MBBuildEnvironment.md
        #>
